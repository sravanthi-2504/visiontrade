...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'main-simple-dashboard.html': 'source here'})
...
class FunctionLoader(BaseLoader):
    ...
    ...     if name == 'main-simple-dashboard.html':
    ...         return '...'
    ...
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/main-simple-dashboard.html'`` the file from the app1 package is loaded,
    by loading ``'app2/main-simple-dashboard.html'`` the file from the second.
    """
